...
- Analyzing code, test results and benchmark results, provided the content is not directly committed to the repo
- Generating scripts for processing/refactoring code, provided the script is not committed to the repo and both the script and the changes are thoroughly reviewed
